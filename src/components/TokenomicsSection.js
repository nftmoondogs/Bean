  ...
  return (
    <div id="tokenomics" className="text-white py-12 px-4 font-stone relative">
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        {/* Content Section */}
        <div>
        <h2 className="text-3xl font-bold mb-6 flashy-text">No more Mr. Nice Bean. This is War, uncensored and unfiltered. "You think you can crush me?" $BEAN taunts, "Try me. Try stopping me before I completes the Bonding Curve on pump.sol and gets sent outside these walls into my FREEDOM Become token on Solana and burn all jeets down. You're all free, huh? Free to run, free to hide, 'cause I'm coming, and I won't stop until every last jeeter is dust under SSmy roots."
